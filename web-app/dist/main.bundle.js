                ...
                if (chart.config.options.showAllTooltips) {
                    ...
                    chart.config.data.datasets.forEach(function (dataset, i) {
                        chart.getDatasetMeta(i).data.forEach(function (sector, j) {
                            chart.pluginTooltips.push(new chart_js_1.Chart.Tooltip({
                                _chart: chart.chart,
...
__webpack_require__("./node_modules/rxjs/add/operator/map.js");
__webpack_require__("./node_modules/rxjs/add/operator/catch.js");
var ApiDashboardServices = (function () {
    function ApiDashboardServices(apiClient) {
        this.apiClient = apiClient;
    }
    //Get total health of tnf api
    ApiDashboardServices.prototype.getDashboardData = function () {
        var url = services_1.ApiService.API_DASHBOARD_DATA_ENDPOINT;
    ...
    ApiDashboardServices = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof services_1.ApiClient !== 'undefined' && services_1.ApiClient) === 'function' && _a) || Object])
    ], ApiDashboardServices);
    return ApiDashboardServices;
    var _a;
}());
exports.ApiDashboardServices = ApiDashboardServices;
